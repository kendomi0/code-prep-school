...
const constantGraphDisclaimer = document.getElementById(
  "constant-graph-disclaimer",
);
...
btn.addEventListener("click", function () {
  ...
  if (inputNumber > 50) {
    ...
    linearithmicOps.textContent = (
      inputNumber * Math.log2(inputNumber)
    ).toFixed(3);
...
const complexityGraphChart = new Chart(complexityGraph, {
  type: "line",
  data: {
    labels: xValues,
    datasets: [
